...
// Gọi  tệp function.php
require 'function.php';


if (isset($_POST['register'])) {
    $username = $_POST['username'];
    $password = md5($_POST['password']); // Mã hóa password bằng md5
            ...
            <div class="col-md-6 text-center login" style="background-image: url('img/bg/memphis-colorful.png');">
                ...
                <form action="" method="post">
                    <div class="form-group user">
                        <input type="text" class="form-control w-50" placeholder="Nhập Tên Đăng kí" name="username" autocomplete="off" required>
                    </div>
                    <div class="form-group my-5">
                        <input type="password" class="form-control w-50" placeholder="Nhập Mật Khẩu" name="password" autocomplete="off" required>
                    </div>
                    <button class="btn btn-primary text-uppercase" type="submit" name="register">Đăng ký</button>
                </form>
            </div>
        </div>
    </div>
